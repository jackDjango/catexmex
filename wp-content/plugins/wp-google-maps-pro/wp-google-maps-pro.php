 ...
 * 5.73 - 2016-07-07 - Medium Priority
 ...
 * Fixed minor conflict with API key usage 
 ...
 *
 * 5.72
 * Fixed a bug that caused the map to reload continuously on some websites
 * 
 * 5.71 - 2016-06-27
...
function wpgmza_pro_menu() {
    ...
    if( function_exists('google_maps_api_key_warning') ){
    	google_maps_api_key_warning();
    } else {
    	echo "<div class='error'><p>";
    	$update = "<a href='".admin_url('update-core.php')."'>".__('update', 'wp-google-maps')."</a>";
    	echo sprintf( __('Please %s the basic version of WP Google Maps to version 6.3.11 or greater.', 'wp-google-maps'), $update );
    	echo "</p></div>";
    }
    echo "
       <div class='wrap'>
...
function wpgmaps_tag_pro( $atts ) {
    ...
    if ((isset($wpgmza_settings['wpgmza_iw_type']) && intval($wpgmza_settings['wpgmza_iw_type']) >= 1) || (isset($map_other_settings['wpgmza_iw_type']) && intval($map_other_settings['wpgmza_iw_type']) >= 1)) {
    	...
    	$iw_custom_styles = "<style>";
    	$iw_custom_styles .=  ".wpgmza_modern_infowindow { background-color: " . (isset($map_other_settings['iw_primary_color']) ? "#" . $map_other_settings['iw_primary_color'] : "#2A3744") . " !important; }";
    	
    	if($wpmgza_info_window !== 1){
    		$iw_custom_styles .=  ".wpgmza_iw_title { color: " . (isset($map_other_settings['iw_text_color']) ? "#" . $map_other_settings['iw_text_color'] : "#ffffff") . " !important; }";
    	} else{
    		$iw_custom_styles .=  " .wpgmza_iw_title { ";
    		$iw_custom_styles .=  "		color: " . (isset($map_other_settings['iw_text_color']) ? "#" . $map_other_settings['iw_text_color'] : "#ffffff") . " !important; " ;
    		$iw_custom_styles .=  "		background-color: " . (isset($map_other_settings['iw_accent_color']) ? "#" . $map_other_settings['iw_accent_color'] : "#252F3A") . " !important;";
    		$iw_custom_styles .=  " }";
    	}

    	$iw_custom_styles .=  ".wpgmza_iw_description { color: " . (isset($map_other_settings['iw_text_color']) ? "#" . $map_other_settings['iw_text_color'] : "#ffffff") . " !important; }";
    	$iw_custom_styles .=  ".wpgmza_iw_address_p { color: " . (isset($map_other_settings['iw_text_color']) ? "#" . $map_other_settings['iw_text_color'] : "#ffffff") . " !important; }";
				...
				<table>
					...
					<tr class='wpgmaps_from_row'>
						...
						<td width='90%' class='wpgmaps_from_td2'>
							<input type=\"text\" value=\"\" id=\"wpgmza_input_from_".$wpgmza_current_map_id."\" style='width:80%' /> $use_location_from
						</td>
					</tr>
...
function wpgmza_pro_advanced_menu() {
    ...
    echo "
        ...
        <div class='wpgmza-listing' style='background-color:white;' >
            $wpgmza_csv
        ...
        <h3>".__("Advanced Settings")."</h3>
        		...
        		<table class='form-table'>
					...
					<tr>
						...
						<td valign='top' width='200' style='vertical-align:top;'>".__('Google Maps API Key (Required)', 'wp-google-maps')."</td>
						<td>
                    ...
                    <tr>
                        ...
                        <td>
                           <select id='wpgmza_api_version' name='wpgmza_api_version'  >
                                       <option value=\"3.23\" ".$wpgmza_api_version_selected[0].">3.23</option>
                                       <option value=\"3.24\" ".$wpgmza_api_version_selected[1].">3.24</option>
        ...
        return "
                ...
                <table class='form-table'>
					...
					<tr>
                         ...
                         <td>
                                <div class='switch'><input name='wpgmza_settings_use_timthumb' class='cmn-toggle cmn-toggle-round-flat' type='checkbox' id='wpgmza_settings_use_timthumb' value='yes' $wpgmza_timchecked /> <label for='wpgmza_settings_use_timthumb'></label></div> ".__("Do not use TimThumb","wp-google-maps")." <em style='color:red;'>
...
function wpgmaps_sl_user_output_pro($map_id) {
    ...
    if (function_exists("wpgmza_register_pro_version") && isset($map_other_settings['store_locator_category']) && $map_other_settings['store_locator_category'] == "1") {
        ...
        if ($filterbycat == 1) {
            ...
            $ret_msg .= "<select mid=\"".$map_id."\" name=\"wpgmza_filter_select\" id=\"wpgmza_filter_select\">";
...
function wpgmaps_return_markers_pro($mapid = false) {
    ...
    foreach ( $results as $result ) {   
		...
		if (isset($result->other_settings)) { $other_data = maybe_unserialize($result->other_settings); } else { $other_data = ''; }
...
function wpgmaps_b_admin_edit_heatmap_javascript($mapid,$polyid) {
        ...
        <?php if( get_option( 'wpgmza_google_maps_api_key' ) ){ ?>
	        <script type="text/javascript">
	        	var gmapsJsHost = (("https:" == document.location.protocol) ? "https://" : "http://");
	        	var wpgmza_api_key = '<?php echo get_option( "wpgmza_google_maps_api_key" ); ?>';
               	document.write(unescape("%3Cscript src='" + gmapsJsHost + "maps.google.com/maps/api/js?sensor=false&libraries=places,visualization&key="+wpgmza_api_key+"' type='text/javascript'%3E%3C/script%3E"));

	        </script>
	    <?php } else { ?>
	        <script type="text/javascript">
	            var gmapsJsHost = (("https:" == document.location.protocol) ? "https://" : "http://");
                       document.write(unescape("%3Cscript src='" + gmapsJsHost + "maps.google.com/maps/api/js?sensor=false&libraries=places,visualization' type='text/javascript'%3E%3C/script%3E"));
	        </script>
	    <?php } ?>
            ...
            MYMAP.init = function(selector, latLng, zoom) {
                ...
                foreach ($total_dataset_array as $poly_id) {
                    ...
                    new google.maps.LatLng(<?php echo $lat; ?>, <?php echo $lng; ?>),            
	              	...
	              	heatmap[<?php echo $poly_id; ?>] = new google.maps.visualization.HeatmapLayer({data: WPGM_PathLineData_<?php echo $poly_id; ?>});
